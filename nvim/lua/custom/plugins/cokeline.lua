return
  {
    ...
    buffers = {
      ...
      filter_valid = function (buf)
        print(buf.filename)
        return buf.type ~= 'nofile' -- NOTE: I'm specifically setting this so when renaming a variable it doesn't show an extra buffer
      end,
    ...
    default_hl = {
      ...
      fg = function(buffer)
        ...
        return hlgroups.get_hl_attr("Normal", "fg")
      end,
...
--    ---@type Component[]
--    components = {}, -- NOTE: Un-commenting this breaks the bufferline and I'm not sure why
--
